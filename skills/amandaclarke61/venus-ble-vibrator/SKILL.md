...
- The bridge server: **[https://github.com/AmandaClarke61/toybrige]** ← replace with your GitHub repo after forking
...
> The server binds to `localhost` only and makes no external network requests. You can review the full source at [server.py](https://github.com/AmandaClarke61/toybrige/blob/main/server.py) and [ble_worker.py](https://github.com/AmandaClarke61/toybrige/blob/main/ble_worker.py) before running.
